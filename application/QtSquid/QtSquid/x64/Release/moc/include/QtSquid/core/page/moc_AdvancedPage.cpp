/****************************************************************************
** Meta object code from reading C++ file 'AdvancedPage.h'
**
...
#include "../../../../../../../include/QtSquid/core/page/AdvancedPage.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'AdvancedPage.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AdvancedPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AdvancedPage_t qt_meta_stringdata_AdvancedPage = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AdvancedPage"
...
QT_INIT_METAOBJECT const QMetaObject AdvancedPage::staticMetaObject = { {
    &Page::staticMetaObject,
    qt_meta_stringdata_AdvancedPage.data,
    qt_meta_data_AdvancedPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AdvancedPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdvancedPage.stringdata0))

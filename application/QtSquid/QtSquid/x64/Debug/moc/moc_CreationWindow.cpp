/****************************************************************************
** Meta object code from reading C++ file 'CreationWindow.h'
**
...
#error "The header file 'CreationWindow.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 31, 6) // "pageID"
    ...
    "CreationWindow\0setCurrentPage\0\0pageID"
};
...
void CreationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CreationWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {

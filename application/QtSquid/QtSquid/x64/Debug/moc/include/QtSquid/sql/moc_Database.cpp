...
#include "../../../../../../include/QtSquid/sql/Database.h"
...
QT_MOC_LITERAL(1, 9, 20), // "successfulConnection"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "Database\0successfulConnection\0"
};
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->successfulConnection(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Database::successfulConnection)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Database::successfulConnection()
{

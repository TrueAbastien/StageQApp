...
public:
    ...
    void setupUi(QDialog *ItemCreation)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(20, 10, 261, 401));
        ...
        FLayout_2_1->setWidget(0, QFormLayout::LabelRole, form_nameLabel);

        form_barcodeLabel = new QLabel(verticalLayoutWidget);
        form_barcodeLabel->setObjectName(QString::fromUtf8("form_barcodeLabel"));

        FLayout_2_1->setWidget(1, QFormLayout::LabelRole, form_barcodeLabel);
        ...
        FLayout_2_1->setWidget(2, QFormLayout::LabelRole, form_manufacturerLabel);

        form_providerLabel = new QLabel(verticalLayoutWidget);
        form_providerLabel->setObjectName(QString::fromUtf8("form_providerLabel"));

        FLayout_2_1->setWidget(3, QFormLayout::LabelRole, form_providerLabel);
        ...
        FLayout_2_1->setWidget(2, QFormLayout::FieldRole, form_manufacturerEdit);

        form_providerEdit = new QLineEdit(verticalLayoutWidget);
        form_providerEdit->setObjectName(QString::fromUtf8("form_providerEdit"));

        FLayout_2_1->setWidget(3, QFormLayout::FieldRole, form_providerEdit);
        ...
        FLayout_2_1->setWidget(4, QFormLayout::FieldRole, form_descriptionEdit);
    ...
    void retranslateUi(QDialog *ItemCreation)
    {
        ...
        outputLabel->setText(QApplication::translate("ItemCreation", "text", nullptr));
